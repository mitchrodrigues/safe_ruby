class SafeRuby
  # IDK about this list will add method to add additional to the list
  ALLOWED_CONSTANTS= 
  [ :Object, :Module, :Class, :BasicObject, :Kernel, :NilClass, :NIL, :Data, :TrueClass, :TRUE, :FalseClass, :FALSE, :Encoding, 
    ...
    :Exception2MessageMapper, :IRB, :RubyToken, :RubyLex, :Readline, :RUBYGEMS_ACTIVATION_MONITOR, :Marshal]
